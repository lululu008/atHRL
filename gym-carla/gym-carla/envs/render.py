...
class BirdeyeRender(object):
    ...
    def _render_hero_actor(self, surface, actor_polygons, world_to_pixel, num):
        lp = len(actor_polygons)
    ...
    def render_hero(self, surface, vehicles):
        self._render_hero_actor(surface, vehicles, self.map_image.world_to_pixel, 10)

    def clip_surfaces(self, clipping_rect):
        self.actors_surface.set_clip(clipping_rect)
        self.result_surface.set_clip(clipping_rect)

    def render(self, display, render_types=None, option='actors'):
        # clock tick
