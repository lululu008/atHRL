...
class DdpgAgent(tf_agent.TFAgent):
    ...
    """
        ...
        if self._ou_stddev is not None:
    ...
    def _train(self, experience, weights=None):
        ...
        #     print(intention)
            # for i in range(len(_intention.action)):
            #     stack = []
            #     for j in range(len(_intention.action[i])):
            #         intention = intention_value(_intention.action[i][j])
            #         stack.append(intention)
            # stack_128 = []
            # for _10 in intention:
            #     stack_10 = []
            #     for _1 in _10:
            #         stack_10.append(intention_value(_1))
            #     print('stack_10:  ', stack_10)
            #     stack_128.append(stack_10)
            # print('stack_128:  ', stack_128)
